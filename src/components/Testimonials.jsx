        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-transform transform hover:scale-105 duration-300 w-full md:w-1/2">
            <p className="text-gray-700 italic mb-4">
              ...
              This coaching center is the best for students in grades 9 to 12.
              The institute is staffed with experienced teachers who not only
              provide excellent education but also motivate every student to
              achieve their best. 👏.
